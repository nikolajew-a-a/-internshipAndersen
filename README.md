...
#### Примечание:
Ветка feature_topic_4_1_1 - простейшая реализация.
Ветка feature_topic_8_1_1 - реализация с помощью архитектуры MVVM. Дополнительно реализовано кэширование в Room на 1 минуту.
